...
class GalaxiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create galaxy" do
    assert_difference('Galaxy.count') do
      post galaxies_url, params: { galaxy: { name: @galaxy.name, planet_id: @galaxy.planet_id } }
    end
  ...
  test "should update galaxy" do
    patch galaxy_url(@galaxy), params: { galaxy: { name: @galaxy.name, planet_id: @galaxy.planet_id } }
