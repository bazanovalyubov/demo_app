...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { country_id: @planet.country_id, name: @planet.name } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { country_id: @planet.country_id, name: @planet.name } }
