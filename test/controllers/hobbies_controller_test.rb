...
class HobbiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hobby" do
    assert_difference('Hobby.count') do
      post hobbies_url, params: { hobby: { hobby_name: @hobby.hobby_name, user_id: @hobby.user_id } }
    end
  ...
  test "should update hobby" do
    patch hobby_url(@hobby), params: { hobby: { hobby_name: @hobby.hobby_name, user_id: @hobby.user_id } }
